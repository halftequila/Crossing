...
SubHub 是一个基于 Cloudflare Workers 的节点订阅管理系统，支持多种代理协议和订阅格式。
...
3. 环境变量设置
   ...
   SUBSCRIBER_URL: https://xxx      # 可选，自选订阅器地址，无作用
   QUICK_SUB_URL: https://xxx      # 可选，快速订阅器地址，无作用
   ```
...
| DEFAULT_TEMPLATE_URL | 否 | 默认订阅模板地址，用于生成配置文件，建议配置自己的需求 |
